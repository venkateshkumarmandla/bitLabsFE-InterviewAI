...
// export default function LearningPlan({ onClose }) {
//   const [selected, setSelected] = useState("");
//   const navigate = useNavigate();
...
//   return (
//     <div className="p-4 border rounded shadow-sm position-relative" style={{ maxWidth: "400px", margin: "auto" }}>
//       {/* Close Icon */}
//       <button onClick={onClose} className="btn btn-light position-absolute" style={{ top: "10px", right: "10px", border: "none" }}>
//         <IoMdClose size={20} />
//       </button>
...
//         {options.map((opt) => (
//           <li key={opt.value} className="mb-2 d-flex align-items-center">
//             <input
//               type="radio"
//               id={opt.value}
//               name="learningOption"
...
//             />
//             <label htmlFor={opt.value} className="form-check-label d-flex align-items-center" style={{ cursor: "pointer" }}>
//               <span className="me-2">{opt.icon}</span> {opt.label}
//             </label>
//           </li>
//         ))}
//       </ul>

//       {/* Bottom Row: Already Setup + Button */}
//       <div className="d-flex justify-content-between align-items-center mt-4">
//         <span className="text-danger fw-semibold">Already setup?</span>
...
export default function LearningPlan({ onClose }) {
  ...
  return (
    <div
      className="p-4 border rounded shadow-sm position-relative bg-white"
    ...
    >
      ...
      {/* Already Setup + Button */}
        <p className="text-danger fw-semibold mb-2">Already setup?</p>
        <input
          className=""
          disabled={!selected}
                    onClick={handleNext}
